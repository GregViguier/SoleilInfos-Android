...
public class MachineStatusFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        timeBeforeNextLoadProgressBar.setMax(MachineStatusViewModel.DEFAULT_REFRESH_PERIOD);
        ...
        viewerModel.getImage().
                observe(this, new Observer<Bitmap>() {
                    @Override
        ...
        viewerModel.getTimeBeforeRefresh().

                observe(this, new Observer<Integer>() {
                    @Override
                    public void onChanged(@Nullable Integer integer) {
                        if (integer != null) {
                            timeBeforeNextLoadProgressBar.setProgress(timeBeforeNextLoadProgressBar.getMax() - integer);
                        }
                    }
                });
        return view;
